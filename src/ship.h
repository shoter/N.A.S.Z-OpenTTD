...
struct Ship FINAL : public SpecializedVehicle<Ship, VEH_SHIP> {
	...
	int GetCurrentMaxSpeed() const { return min(this->vcache.cached_max_speed, this->current_order.GetMaxSpeed() * 2) / _settings_game.ourSettings.vehicleSpeedMultiplier; }
